...
export function Portfolio() {
  ...
  const slider4 = import.meta.glob("/portfolio/4LM-APTO41/*.(jpg|png|jpeg)");
  const slider5 = import.meta.glob(
    "/portfolio/5M_V-ISABELAFRAIA/*.(jpg|png|jpeg)"
  );
  const slider6 = import.meta.glob("/portfolio/7JR-DUDASENNA/*.(jpg|png|jpeg)");
