...
export function Portfolio() {
  const slider1 = import.meta.globEager("/portfolio/1AK-SALA2/*.(jpg|png|jpeg)");
  const slider2 = import.meta.globEager("/portfolio/2G_M-FelipeKilares/*.(jpg|png|jpeg)");
  const slider3 = import.meta.globEager("/portfolio/3B_R-SALA2/*.(jpg|png|jpeg)");
  const slider4 = import.meta.globEager("/portfolio/4LM-APTO41/*.(jpg|png|jpeg)");
  const slider5 = import.meta.globEager("/portfolio/5M_V-ISABELAFRAIA/*.(jpg|png|jpeg)");
  // const slider6 = import.meta.globEager("/portfolio/7JR-DUDASENNA/*.(jpg|png|jpeg)");
  const slider7 = import.meta.globEager("/portfolio/8A_C-FSTUDIO/*.(jpg|png|jpeg)");
  const slider8 = import.meta.globEager("/portfolio/9B_G-SALA2/*.(jpg|png|jpeg)");
  const slider9 = import.meta.globEager("/portfolio/10M_B/*.(jpg|png|jpeg)");
  const slider10 = import.meta.globEager("/portfolio/12L_G-FIGUEIREDO_FISCHER/*.(jpg|png|jpeg)");
  const slider11 = import.meta.globEager("/portfolio/13LABORATORIO_GUARULHOS/*.(jpg|png|jpeg)");
  const slider12 = import.meta.globEager("/portfolio/14WENTZ-FELIPE_HESS/*.(jpg|png|jpeg)");
  const slider13 = import.meta.globEager("/portfolio/15RESTAURANTE-ESTUDIO_PENHA/*.(jpg|png|jpeg)");
